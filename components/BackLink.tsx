...
export default function BackLink({ label = "뒤로" }: { label?: string }) {
  return (
    <button
      ...
      className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-surf px-4 py-2 text-[14.5px] font-medium text-body transition hover:bg-tint hover:text-ink"
    >
